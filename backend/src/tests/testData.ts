...
// Test client credit values used in client.test.ts.
export const firstClientCredits = 500;
export const secondClientCredits = 50;
export const thirdClientCredits = 100;
